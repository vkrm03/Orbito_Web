...
import {
  FaTrain, FaExchangeAlt, FaCalendarAlt,
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 to-purple-600">
      ...
      <div className="relative z-10 w-full max-w-3xl bg-white bg-opacity-90 backdrop-blur-md rounded-xl shadow-2xl p-8 space-y-6">
        <h2 className="text-2xl font-bold text-center text-gray-800">Search Trains</h2>
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-5">
            ...
            <div className="relative">
              ...
              <input type="text" placeholder="Departure station" value={from} onChange={e => setFrom(e.target.value)} className="pl-10 w-full py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-400" />
            </div>
          </div>
          ...
          <div className="col-span-5">
            ...
            <div className="relative">
              <FaMapMarkerAlt className="absolute left-3 top-3 text-gray-400" />
              <input type="text" placeholder="Destination station" value={to} onChange={e => setTo(e.target.value)} className="pl-10 w-full py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-400" />
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <select value={trainClass} onChange={e => setTrainClass(e.target.value)} className="w-full py-2 px-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-400">
